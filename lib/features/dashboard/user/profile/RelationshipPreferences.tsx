    ...
    <div className="w-full bg-white rounded-[10px]">
      ...
      <div className="w-full grid grid-cols-3 px-[36px] py-[25px]">
        <div className="flex flex-col items-start gap-1">
          <p className="text-[14px] font-semibold">Interested In</p>
          <p className="text-[14px] font-normal capitalize">
            {userProfile.interestedInGender || "N/A"}
          </p>
        </div>
        <div className="flex flex-col items-start gap-1">
          <p className="text-[14px] font-semibold">Looking For</p>
          <p className="text-[14px] font-normal capitalize">
            {userProfile.lookingFor || "N/A"}
          </p>
        </div>
        <div className="flex flex-col items-start gap-1">
          <p className="text-[14px] font-semibold">Age Range Preferences</p>
          <p className="text-[14px] font-normal capitalize">
      ...
      <div className="w-full grid grid-cols-3 px-[36px] py-[25px]">
        <div className="flex flex-col items-start gap-1">
          <p className="text-[14px] font-semibold">Preferred Nationality</p>
          <p className="text-[14px] font-normal capitalize">
        ...
        <div className="flex flex-col items-start gap-1">
          <p className="text-[14px] font-semibold">Religious Preferences</p>
          <p className="text-[14px] font-normal capitalize">
      ...
      <div className="w-full grid grid-cols-2 px-[36px] py-[25px]">
        <div className="flex flex-col items-start gap-1">
          <p className="text-[14px] font-semibold">Partner Expectations</p>
          <p className="text-[14px] font-normal">
