    ...
    <div className="w-full bg-white rounded-[10px]">
      ...
      <div className="w-full grid grid-cols-3 px-[36px] py-[25px]">
        <div className="flex flex-col items-start gap-1">
          <p className="text-[14px] font-semibold">Height</p>
          <p className="text-[14px] font-normal">
            {userProfile.heightCm || "N/A"} cm
          </p>
        </div>
        <div className="flex flex-col items-start gap-1">
          <p className="text-[14px] font-semibold">Weight</p>
          <p className="text-[14px] font-normal">
            {userProfile.weightKg || "N/A"} KG
          </p>
        </div>
        <div className="flex flex-col items-start gap-1">
          <p className="text-[14px] font-semibold">Body Type</p>
      ...
      <div className="w-full grid grid-cols-3 px-[36px] py-[25px]">
        <div className="flex flex-col items-start gap-1">
          <p className="text-[14px] font-semibold">Drinking Habit</p>
          <p className="text-[14px] font-normal">
            {formatLabel(userProfile.drinkingHabit) || "N/A"}
          </p>
        </div>
        <div className="flex flex-col items-start gap-1">
          <p className="text-[14px] font-semibold">Smoking Habit</p>
          <p className="text-[14px] font-normal">
            {formatLabel(userProfile.smokingHabit) || "N/A"}
          </p>
        </div>
        <div className="flex flex-col items-start gap-1">
          <p className="text-[14px] font-semibold">Pets</p>
          <p className="text-[14px] font-normal capitalize">
      ...
      <div className="w-full grid grid-cols-3 px-[36px] py-[25px]">
        <div className="flex flex-col items-start gap-1">
          <p className="text-[14px] font-semibold">Health Condition</p>
          <p className="text-[14px] font-normal">
            {formatLabel(userProfile.healthCondition) || "N/A"}
          </p>
        </div>
        <div className="flex flex-col items-start gap-1">
          <p className="text-[14px] font-semibold">Dietary Preference</p>
          <p className="text-[14px] font-normal">
